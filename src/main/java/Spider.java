...
public class Spider {
    //https://www.tooopen.com/img/88_878.aspx
    public static String path = "https://www.tupianzj.com/meinv/20160611/52882.html";
    public static int num = -1, sum = 0;
    public static final String WORKSPACE = "D:/Spider/";
    /**
    ...
    public static void getAllLinks(String path) {
        ...
        for (Element element : imgLinks) {
            ...
            if (!readTxtFile(imgLinkFile).contains(srcStr)) {
                ...
                downloadPicture(srcStr,WORKSPACE);
            }
        }
        num++;
        if (sum > num) {
    ...
    * */
    private static void downloadPicture(String urlList,String path) {
        ...
        try {
            ...
            FileOutputStream fileOutputStream = new FileOutputStream(new File(path+"images/"+s+".jpg"));
